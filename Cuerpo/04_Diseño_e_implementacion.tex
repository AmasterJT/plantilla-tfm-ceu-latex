...
\nombreCapituloCabecera{RH}{Diseño e implementación} % Título de la sección en la cabecera

\section{Diseño e implementación} % Título del capítulo
\label{sec:diseño-implementación}
